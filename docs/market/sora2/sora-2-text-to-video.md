  ...
  /api/v1/jobs/createTask:
    post:
      ...
      description: >-
        ...
        Sora-2-text-to-video's advanced AI model
      ...
      operationId: sora-2-text-to-video
      tags:
          ...
          application/json:
              ...
              properties:
                model:
                  ...
                  description: |-
                    ...
                    - Must be `sora-2-text-to-video` for this endpoint
                  examples:
                    - sora-2-text-to-video
                callBackUrl:
                  type: string
                ...
                input:
                  ...
                  properties:
                    prompt:
                      ...
                      examples:
                        - >-
                          A professor stands at the front of a lively classroom,
                          enthusiastically giving a lecture. On the blackboard
                          behind him are colorful chalk diagrams. With an
                          animated gesture, he declares to the students: “Sora 2
                          is now available on Kie AI, making it easier than ever
                          to create stunning videos.” The students listen
                          attentively, some smiling and taking notes.
                    aspect_ratio:
            ...
            example:
              ...
              input:
                prompt: >-
                  A professor stands at the front of a lively classroom,
                  enthusiastically giving a lecture. On the blackboard behind
                  him are colorful chalk diagrams. With an animated gesture, he
                  declares to the students: “Sora 2 is now available on Kie AI,
                  making it easier than ever to create stunning videos.” The
                  students listen attentively, some smiling and taking notes.
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/1184766/apis/api-28506413-run
components:
  schemas:
    ApiResponse:
      type: object
